...
impl CollaborationModeIndicator {
    fn label(self, show_cycle_hint: bool) -> String {
        ...
        match self {
            ...
            CollaborationModeIndicator::Heavy => format!("Heavy mode{suffix}"),
            CollaborationModeIndicator::HeavyPlan => format!("Heavy Plan mode{suffix}"),
    ...
    fn styled_span(self, show_cycle_hint: bool) -> Span<'static> {
        ...
        match self {
            ...
            CollaborationModeIndicator::Heavy => Span::from(label).cyan(),
            CollaborationModeIndicator::HeavyPlan => Span::from(label).green(),
...
mod tests {
    ...
    fn footer_snapshots() {
        ...
        snapshot_footer_with_mode_indicator(
            "footer_mode_indicator_default_wide",
            120,
            &props,
            Some(CollaborationModeIndicator::Default),
        );

        snapshot_footer_with_mode_indicator(
            "footer_mode_indicator_heavy_wide",
            120,
            &props,
            Some(CollaborationModeIndicator::Heavy),
        );

        snapshot_footer_with_mode_indicator(
            "footer_mode_indicator_heavy_plan_wide",
            120,
            &props,
            Some(CollaborationModeIndicator::HeavyPlan),
        );
